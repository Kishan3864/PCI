    ...
    >
      ...
      <g fontFamily="ui-monospace, monospace" fontSize="10">
        <rect
          ...
          strokeWidth="1"
        />
        <text x="280" y="56" textAnchor="middle" fill="#6ee7b7">
          stripe.js ✓
        </text>
        <rect
          x="216"
          ...
          strokeWidth="1"
        />
        <text x="280" y="92" textAnchor="middle" fill="#6ee7b7">
          checkout.js ✓
        </text>
        <rect
          x="216"
          ...
          strokeWidth="1"
        />
        <text x="280" y="128" textAnchor="middle" fill="#6ee7b7">
          gtm.js ✓
        </text>
        {/* malicious */}
        <g>
          <rect
            ...
            width="128"
            height="24"
            fill="rgba(76,5,25,0.55)"
            stroke="rgba(251,113,133,0.7)"
            strokeWidth="1.5"
            strokeDasharray="4 3"
          />
          <text x="280" y="244" textAnchor="middle" fill="#fda4af">
            skimmer.js ✕
          </text>
        </g>
      </g>
      ...
      <g>
        <path
          d="M420 96 464 112 v40 c0 26-18 46-44 55 -26-9-44-29-44-55 v-40 z"
          fill="rgba(34,211,238,0.1)"
          stroke="url(#td-cyan)"
          strokeWidth="2"
        />
        <path
          d="M403 152 l12 12 22 -26"
          fill="none"
          stroke="#67e8f9"
          strokeWidth="3.5"
          strokeLinecap="round"
      ...
      <g>
        <path
          d="M216 240 C 196 240 190 190 170 178"
          fill="none"
          stroke="rgba(251,113,133,0.65)"
          strokeWidth="1.5"
          strokeDasharray="5 4"
          markerEnd="url(#td-arrow-red)"
        />
        <g>
          <circle cx="193" cy="212" r="11" fill="#1c0a12" stroke="#fb7185" strokeWidth="1.5" />
          <path
            d="M188 207 l10 10 M198 207 l-10 10"
            stroke="#fb7185"
            strokeWidth="2"
            strokeLinecap="round"
          />
      ...
      <g>
        ...
        <path
          d="M446 210 C 460 224 470 240 476 254"
          fill="none"
