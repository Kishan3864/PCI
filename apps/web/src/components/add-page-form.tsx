      ...
      <div className="grid gap-4 sm:grid-cols-[1fr_10rem_9rem]">
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            name="scanFrequency"
            defaultValue="daily"
            className="flex h-9 w-full rounded-[2px] border border-slate-300 bg-white px-3 py-1 text-sm text-navy-900 shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500/60"
          >
